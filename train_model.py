...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--sd_finetune_from", type=str, nargs="?", required=True,
                        help="path to stable diffusion checkpoint to load SD model state from")
    parser.add_argument("--adapter_finetune_from", type=str, nargs="?", default="",
                        help="path to stable diffusion checkpoint to load adapter model state from")
    parser.add_argument("--coadapter_finetune_from", type=str, nargs="?", default="",
